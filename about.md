...
チャンネル装飾つくる
もくもくでgit
:ballot_box_with_check:ロール個別表示いじる
:ballot_box_with_check:VPS申込み
> イメージをローカル保存できないのが辛いので保留。
:ballot_box_with_check:ユーザー設定修正
:ballot_box_with_check:絵文字とりあえず追加する
:ballot_box_with_check:サーバとカテゴリロールいじる
:ballot_box_with_check:IFTTTのwebhookいじる
:ballot_box_with_check:dynmapをリバースプロキシする
:ballot_box_with_check:ubuntuにapache2導入
